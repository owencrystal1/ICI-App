...
try:
    ...
    with col2:
        st.title(f"Immune Checkpoint Inhibitor Adverse Cardiac Event Risk Calculator")
    
    st.write("The tool provided on this platform are intended for research and educational purposes only. Any use of these tools in a clinical workflow is done at the user's risk.")
